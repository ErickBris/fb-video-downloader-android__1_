...
public class T_ProductTourActivity extends ActionBarActivity {
	...
	private void setIndicator(int index){
		if(index < NUM_PAGES){
			for(int i = 0 ; i < NUM_PAGES - 1 ; i++){
				...
				if(i == index){
					circle.setColorFilter(getResources().getColor(R.color.circle));
				}else {
					circle.setColorFilter(getResources().getColor(R.color.m_tab_clr));
				}
			}
		}
	}
	...
	private class ScreenSlidePagerAdapter extends FragmentStatePagerAdapter {
		...
		public Fragment getItem(int position) {
			T_ProductTourFragment tp = null;
			switch(position){
			case 0:
				tp = T_ProductTourFragment.newInstance(R.layout.welcome_fragment1);
				break;
			case 1:
				tp = T_ProductTourFragment.newInstance(R.layout.welcome_fragment2);
				break;
			case 2:
				tp = T_ProductTourFragment.newInstance(R.layout.welcome_fragment3);
				break;
			case 3:
				tp = T_ProductTourFragment.newInstance(R.layout.welcome_fragment4);
				break;
			case 4:
				tp = T_ProductTourFragment.newInstance(R.layout.welcome_fragment5);
				break;
			}
	...
	private PackageInfo getPackageInfo() {
		PackageInfo pi = null;
		try {
			pi = T_ProductTourActivity.this.getPackageManager().getPackageInfo(T_ProductTourActivity.this.getPackageName(), PackageManager.GET_ACTIVITIES);
