...
public class FT_ProductTourActivity extends ActionBarActivity {
	...
	private class ScreenSlidePagerAdapter extends FragmentStatePagerAdapter {
		...
		public Fragment getItem(int position) {
			...
			switch(position){
			case 0:
				tp = T_ProductTourFragment.newInstance(R.layout.f_welcome_fragment1);
				break;
			case 1:
				tp = T_ProductTourFragment.newInstance(R.layout.f_welcome_fragment2);
				break;
			case 2:
				tp = T_ProductTourFragment.newInstance(R.layout.f_welcome_fragment3);
				break;
			case 3:
				tp = T_ProductTourFragment.newInstance(R.layout.f_welcome_fragment4);
				break;
			case 4:
				tp = T_ProductTourFragment.newInstance(R.layout.f_welcome_fragment5);
				break;
			}
	...
	private PackageInfo getPackageInfo() {
		PackageInfo pi = null;
		try {
			pi = FT_ProductTourActivity.this.getPackageManager().getPackageInfo(FT_ProductTourActivity.this.getPackageName(), PackageManager.GET_ACTIVITIES);
