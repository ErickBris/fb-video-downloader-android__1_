...
private static final int DATABASE_VERSION = 1;
	...
	public	void AddtoFavorite(Pojo pj)
	{
		...
		values.put(KEY_URL, pj.getNameUrl());
		...
		public List<Pojo> getAllData() 
		{
			...
			if (cursor.moveToFirst()) 
			{
				do {
					...
					contact.setNameUrl(cursor.getString(1));
	...
	//getting single row
		...
		public List<Pojo> getFavRow(String id) 
		{
			List<Pojo> dataList = new ArrayList<Pojo>();
			// Select All Query
			String selectQuery = "SELECT  * FROM " + TABLE_NAME +" WHERE url="+"'"+id+"'";
	...
	//for remove favorite
		...
		{
		    SQLiteDatabase db = this.getWritableDatabase();
//		    db.delete(TABLE_NAME, KEY_URL + " = ?",
//		            new String[] { String.valueOf(contact.getNameUrl()) });
//		    db.close();
		    
		    String selectQuery = "delete from Favorite where url="+"'"+contact.getNameUrl()+"'";
